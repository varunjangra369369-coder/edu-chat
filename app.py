...
LAST_SYNC_TIME = 0
SYNC_COOLDOWN = 15 # Wait 15 seconds between automatic syncs
...
def load_data(force=False):
    ...
    print("🔄 Pulling live data from Google Sheets...")
    try:
...
<div class="row justify-content-center"><div class="col-md-5"><div class="card p-4">
    ...
    <form action="/teacher_login" method="POST">
        ...
        <div class="mb-3"><label class="form-label">Username</label><input type="text" name="username" class="form-control" required autocomplete="username"></div>
        <div class="mb-4"><label class="form-label">Password</label><input type="password" name="password" class="form-control" required autocomplete="current-password"></div>
        ...
        <div class="row">
            ...
            <div class="col-md-8 mb-4">
                <div class="card p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center p-3 border rounded mb-2 bg-light flex-wrap gap-2">
                        <span class="fw-bold fs-5 w-100"><i class="fa-solid fa-users text-primary me-2"></i>{{ c_info.name }}</span>
                        <form action="/admin/change_class_pw/{{ c_id }}" method="POST" class="d-flex flex-grow-1 m-0">
                            ...
                            <button class="btn btn-sm btn-dark me-2 fw-bold">Change PW</button>
                        </form>
                        <form action="/admin/delete_class/{{ c_id }}" method="POST" class="m-0" onsubmit="return confirm('Delete this class entirely?');">
                            <button class="btn btn-sm btn-danger fw-bold"><i class="fa-solid fa-trash me-1"></i>Delete Class</button>
                        </form>
                    </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card p-4 border-top border-4 border-dark">
                    ...
                    <form action="/admin/change_password" method="POST" autocomplete="off">
                        ...
                        <button class="btn btn-dark w-100 mb-3">Update My Password</button>
                    </form>
                    <hr>
...
<div class="row justify-content-center"><div class="col-md-5"><div class="card p-4">
    ...
    <form action="/student_login_class" method="POST" class="pt-3 border-top" autocomplete="off">
        ...
        <button type="submit" class="btn btn-primary w-100 btn-lg">Enter Class</button>
    </form>
    {% endif %}
</div></div></div>
""")
...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 bg-white p-4 rounded shadow-sm border-start border-4 border-success">
    <div>
...
<ul class="nav nav-tabs mb-4" id="teacherTabs" role="tablist">
  <li class="nav-item"><button class="nav-link active fw-bold fs-5" data-bs-toggle="tab" data-bs-target="#current">Current Session</button></li>
  <li class="nav-item"><button class="nav-link fw-bold fs-5" data-bs-toggle="tab" data-bs-target="#history">Message History</button></li>
</ul>
